...
MODEL_NAME = "recommender_base_co_clustering_surprise"
...
class Recommender:
    def __init__(self, n_cltr_u=3, n_cltr_i=3, **kwargs):
        self.n_cltr_u  = n_cltr_u 
        self.n_cltr_i  = n_cltr_i 
        self.ma = None
        self.mi = None
        self.model = CoClustering(n_cltr_u =self.n_cltr_u, n_cltr_i = self.n_cltr_i )
        return
    ...
    def save(self, model_path):   
        model_params = {
            "n_cltr_u": self.n_cltr_u,
            "n_cltr_i": self.n_cltr_i
        }
